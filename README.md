...
## Licence, attribution and the images

The code is MIT — see [LICENSE](LICENSE).

The images are model output, generated in September 2026 by:

- **Gemini 3 Pro Image** (`gemini-3-pro-image`), Google, via Vertex AI
- **gpt-image-2**, OpenAI
- **Stable Diffusion 3.5 Large**, Stability AI, via Amazon Bedrock

Powered by Stability AI.

All three providers assign output ownership to the user. Google does not claim
ownership of Generated Output and treats it as Customer Data under the Google
Cloud Service Specific Terms. OpenAI's Terms of Use assign the customer "all
our right, title, and interest, if any, in and to Output". Stability AI's
Community License states "You own any outputs generated from the Models or
Derivative Works to the extent permitted by applicable law", and permits
commercial use below USD $1M annual revenue.

Two caveats worth knowing if you reuse this pattern. Purely AI-generated output
may not attract copyright protection at all in some jurisdictions, which is a
separate question from who owns it. And Stable Diffusion here was accessed as a
hosted service through Amazon Bedrock, where third-party models are Third-Party
Content under the AWS Service Terms and may carry the seller's own EULA — not
identical to self-hosting the weights under the Community License.

None of this is legal advice; check the current terms yourself before reusing
anything here.
