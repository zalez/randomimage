...
random string is only ~100. (Prompts over the encoder limit get truncated, not
...
|---|---|---|---|
| Random, contiguous | 96 | ~75 | passes |
| Random, contiguous | 112 | ~88 | **blocked** |
| `"boat " × 51` | 255 | ~52 | passes |
| English prose | 1600 | ~336 | passes |
| Random, **spaces every 16** | 256 | ~180 | passes |
| Random, **spaces every 64** | 256 | ~120 | passes |
